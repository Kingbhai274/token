...
\033[1;97mвЂў-----------------\033[1;37mNeel\033[1;97m-----------------вЂў
"""
...
while (loop == 'true'):
    ...
    if (username ==" Baloch" CorrectUsername):
    	password = "mafia" raw_input("\033[1;91m[+] \033[1;91m \x1b[1;91mTool Password \x1b[1;91m: \x1b[1;97m")
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:-STORM-BOYS
	    time.sleep(2)
            loop = 'false'
        else:
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				unikers.close()
				print '\033[1;47m\033[1;91mNeel Login Successful\033[1;0m'
				os.system('xdg-open ')
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:-STORM-BOYS
	print logo
...
def pilih_super():
	...
	p.map(main, id)
#Dev:NEEL AHMAD
        print "\033[1;97mвЂў-----------------\033[1;37mрџ”ҐNEELahmad”Ґ\033[1;97m-----------------вЂў"
...
""
	print "\033[1;97mВ«-----------------\033[1;37mвњ…NEELвњ…\033[1;97m-----------------В»"
